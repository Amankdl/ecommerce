...
if (isset($_SESSION['USER_LOGGEDIN'])) {
        ...
        $connection -> get("SELECT * FROM wishlist w INNER JOIN product p ON p.id = w.pid WHERE user_id = $user_id ORDER BY w.id desc");
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        echo '<tr>
                                            ...
                                            <td class="product-remove"><a href="javascript:void(0)" onclick="manage_wishlist('.$product["id"].",'delete'".')"><i class="icon-trash icons"></i></a></td>
                                        </tr>';
                                        }
                                        ?>
                                    </tbody>
