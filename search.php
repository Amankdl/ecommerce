...
if (isset($_GET['keyword'])) {
    ...
    $connection->get("SELECT *, p.id FROM product p INNER JOIN categories c ON p.category_id = c.id where c.status = 1 and p.status = 1 and (p.product_name LIKE '%$keyword%' or p.description LIKE '%$keyword%') ORDER BY p.id DESC");
                ...
                <div class="col-xs-12">
                    <div class="bradcaump__inner">
                        <nav class="bradcaump-inner">
                            ...
                            <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                            <span class="breadcrumb-item active"><?php echo $keyword ?></span>
                        </nav>
                    </div>
                </div>
            </div>
